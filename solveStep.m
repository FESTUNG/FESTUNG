...
% Water height
hSys = cSys{1} + problemData.tau * ( problemData.barGlobM \ (problemData.globLh - problemData.barGlobJuh - problemData.barGlobKh + ...
            (problemData.barGlobG - problemData.barGlobP - problemData.barGlobPbdr) * cSys{1}) );
% Horizontal velocity
cSys{2} = cSys{2} + problemData.tau * ( problemData.globM \ (problemData.globLu - problemData.globKu - ...
            problemData.globJh - problemData.globJuu - problemData.globJq + ...
