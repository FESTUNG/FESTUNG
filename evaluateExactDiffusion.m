function [ rhs ] = evaluateExactDiffusion(g, t, markE0T, funcCont, qOrd, basesOnQuad)
...
for i = 1 : 4
    ...
    rhs = rhs + funcCont(t,Q1,Q2) * (repmat(W.', 1, size(basesOnQuad.phi1D(:,:,i),2)) ...
            .* basesOnQuad.phi1D(:,:,i)) .* kron((markE0T(:,i) .* g.areaE0T(:,i)), ones(1, size(basesOnQuad.phi2D, 2)));
end
