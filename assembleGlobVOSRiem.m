function globVOSRiem = assembleGlobVOSRiem(g, markE0TOS, HOS, PhiPhidiag, lambdaOSRiem, basesOnQuad, areaE0Tbdr)
...
for n = 1 : 3
  ...
  globVOSRiem{2} = globVOSRiem{2} + ( HOS{n} .* lambdaOSRiem{n} .* ( ones(K,1) * W ) ) * basesOnQuad.phi1D{qOrd}(:, :, n);
end % for
