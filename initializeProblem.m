...
hDisc = projectFuncCont2DataDiscTrap(problemData.g, h0Cont, problemData.qOrd, ...
                                     problemData.hatM{1}, problemData.basesOnQuad);
q1Disc = projectFuncCont2DataDiscTrap(problemData.g, q10Cont, problemData.qOrd, ...
                                      problemData.hatM{1}, problemData.basesOnQuad);
q2Disc = projectFuncCont2DataDiscTrap(problemData.g, q20Cont, problemData.qOrd, ...
                                      problemData.hatM{1}, problemData.basesOnQuad);
