...
%> @endparblock
%
function ret = assembleMatEdgePhiLagrNu(g, markE0Tbdr, refEdgePhiLagrPerQuad, areaNuE0Tbdr)
% Extract dimensions
K = g.numT;
...
if nargin > 3
  ret = assembleMatEdgePhiLagrNu_withAreaNuE0Tbdr(g, refEdgePhiLagrPerQuad, areaNuE0Tbdr);
elseif isfield(g, 'areaNuE0T')
  ret = assembleMatEdgePhiLagrNu_noAreaNuE0Tbdr_withAreaNuE0T(g, markE0Tbdr, refEdgePhiLagrPerQuad);
else
  ret = assembleMatEdgePhiLagrNu_noAreaNuE0Tbdr_noAreaNuE0T(g, markE0Tbdr, refEdgePhiLagrPerQuad);
end % if
end % function
%
%===============================================================================
%> @brief Helper function for the case that assembleMatEdgePhiLagrNu()
%> was called with a precomputed field areaNuE0Tbdr.
%
function ret = assembleMatEdgePhiLagrNu_withAreaNuE0Tbdr(g, refEdgePhiLagrPerQuad, areaNuE0Tbdr)
% Extract dimensions
L = g.numV;
...
for n = 1	:	3
	...
	ret{n,1} = kron(bsxfun(@times, markV0E0T, areaNuE0Tbdr{n,1}'), refEdgePhiLagrPerQuad(mod(n,3)+1,n,:));
  ret{n,2} = kron(bsxfun(@times, markV0E0T, areaNuE0Tbdr{n,2}'), refEdgePhiLagrPerQuad(mod(n,3)+1,n,:));
  
  markV0E0T = sparse(bsxfun(@eq, (1:L), g.V0T(:,mod(n+1,3)+1)))';
	ret{n,1} = ret{n,1} + kron(bsxfun(@times, markV0E0T, areaNuE0Tbdr{n,1}'), refEdgePhiLagrPerQuad(mod(n+1,3)+1,n,:));
  ret{n,2} = ret{n,2} + kron(bsxfun(@times, markV0E0T, areaNuE0Tbdr{n,2}'), refEdgePhiLagrPerQuad(mod(n+1,3)+1,n,:));
end % for
end % function
%
%===============================================================================
...
%
function ret = assembleMatEdgePhiLagrNu_noAreaNuE0Tbdr_withAreaNuE0T(g, markE0Tbdr, refEdgePhiLagrPerQuad)
% Extract dimensions
L = g.numV;
...
for n = 1 : 3
  markV0E0T = sparse(bsxfun(@eq, (1:L), g.V0T(:,mod(n,3)+1)))'; 
  ret{n,1} = kron(bsxfun(@times, markV0E0T, markE0Tbdr(:,n)' .* g.areaNuE0T{n,1}'), refEdgePhiLagrPerQuad(mod(n,3)+1,n,:));
  ret{n,2} = kron(bsxfun(@times, markV0E0T, markE0Tbdr(:,n)' .* g.areaNuE0T{n,2}'), refEdgePhiLagrPerQuad(mod(n,3)+1,n,:));
  
  markV0E0T = sparse(bsxfun(@eq, (1:L), g.V0T(:,mod(n+1,3)+1)))'; 
  ret{n,1} = ret{n,1} + kron(bsxfun(@times, markV0E0T, markE0Tbdr(:,n)' .* g.areaNuE0T{n,1}'), refEdgePhiLagrPerQuad(mod(n+1,3)+1,n,:));
  ret{n,2} = ret{n,2} + kron(bsxfun(@times, markV0E0T, markE0Tbdr(:,n)' .* g.areaNuE0T{n,2}'), refEdgePhiLagrPerQuad(mod(n+1,3)+1,n,:));
end % for
end % function
%
%===============================================================================
...
%
function ret = assembleMatEdgePhiLagrNu_noAreaNuE0Tbdr_noAreaNuE0T(g, markE0Tbdr, refEdgePhiLagrPerQuad)
% Extract dimensions
L = g.numV;
...
for n = 1 : 3
  ...
  ret{n,1} = kron(Qkn1, refEdgePhiLagrPerQuad(mod(n,3)+1,n,:));
  ret{n,2} = kron(Qkn2, refEdgePhiLagrPerQuad(mod(n,3)+1,n,:));
  ...
  ret{n,1} = ret{n,1} + kron(Qkn1, refEdgePhiLagrPerQuad(mod(n+1,3)+1,n,:));
  ret{n,2} = ret{n,2} + kron(Qkn2, refEdgePhiLagrPerQuad(mod(n+1,3)+1,n,:));
end % for
end % function
