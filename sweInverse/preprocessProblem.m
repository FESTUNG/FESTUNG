...
%===============================================================================
%> @file sweInverse/preprocessProblem.m
%>
...
switch pd.gridSource
  ...
  case 'ADCIRC'
    ...
    [ pd.g, pd.depth, forcingOS, flowRateRiv, flowRate ] = execin('sweInverse/domainADCIRC', ['sweInverse/fort_' pd.name '.14'], ['sweInverse/fort_' pd.name '.17'], ...
