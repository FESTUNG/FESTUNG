...
% compute their harmonic averages of Roe-Pike type for flow boundary edges.
%
%===============================================================================
%> @file sweInverse/computeAveragedVariablesQ0E0Tflow.m
%>
%> @brief Uses the evaluation of the unknowns of the 2D Shallow-Water Equations 
%>        to compute their harmonic averages of Roe-Pike type for flow boundary 
...
%> due to the model formulation in which the limits of the height on the flow 
...
%>
%> @copyright 2014-2017 Hennes Hajduk, Balthasar Reuter, Florian Frank, Vadym Aizinger
%> 
%> @par License
%> @parblock
...
%> @endparblock
%>
function cRoePikeQ0E0T = computeAveragedVariablesQ0E0Tflow(cQ0E0Tint, cQ0E0Text, hQ0E0Tint, hQ0E0Text, markQ0E0Tbdr, averagingType)
