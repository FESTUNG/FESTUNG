...
hDisc = projectFuncCont2DataDiscTrap(problemData.g, h0Cont, problemData.N, problemData.qOrd, ...
                                     problemData.globM, problemData.basesOnQuad);
q1Disc = projectFuncCont2DataDiscTrap(problemData.g, q10Cont, problemData.N, problemData.qOrd, ...
                                      problemData.globM, problemData.basesOnQuad);
q2Disc = projectFuncCont2DataDiscTrap(problemData.g, q20Cont, problemData.N, problemData.qOrd, ...
                                      problemData.globM, problemData.basesOnQuad);
...
if problemData.isVisSol
  ...
  visualizeDataLagrTrap(problemData.g, hLagr, 'h', problemData.outputBasename, 0);
end % if
