...
%> weights <code>W</code>.  The quadrature rule is exact for polynomials of order <code>qOrd</code> (see @ref FRAK2015 for details).
...
switch qOrd
  ...
  case 3 % R = 4
    a1 = (3 + sqrt(3))/6;   a2 = (3 - sqrt(3))/6;
    b1 = (6 + sqrt(6))/10;  b2 = (6 - sqrt(6))/10;
    w1 = 1/8 + sqrt(6)/72;  w2 = 1/8 - sqrt(6)/72;
    Q1 = [a1*b1, a2*b1, a1*b2, a2*b2];
    Q2 = [a2*b1, a1*b1, a2*b2, a1*b2];
    W  = [w1, w1, w2, w2];
  case 4 % R = 6
