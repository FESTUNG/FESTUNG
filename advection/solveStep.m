...
for rkStep = 1 : length(omega)
  ...
  fDisc  = projectFuncCont2DataDisc(problemData.g, @(x1,x2) problemData.fCont(t(rkStep),x1,x2),  2*problemData.p, problemData.hatM);
  u1Disc = projectFuncCont2DataDisc(problemData.g, @(x1,x2) problemData.u1Cont(t(rkStep),x1,x2), 2*problemData.p, problemData.hatM);
  u2Disc = projectFuncCont2DataDisc(problemData.g, @(x1,x2) problemData.u2Cont(t(rkStep),x1,x2), 2*problemData.p, problemData.hatM);
  ...
  globR = assembleMatEdgePhiPhiValUpwind(problemData.g, problemData.hatRdiagOnQuad, problemData.hatRoffdiagOnQuad, vNormalOnQuadEdge);
  ...
  globKD = assembleVecEdgePhiIntFuncContVal(problemData.g, problemData.g.markE0TbdrD, ...
            @(x1,x2) problemData.cDCont(t(rkStep),x1,x2), vNormalOnQuadEdge, N, problemData.g.areaE0TbdrD);
  ...
  if problemData.isSlopeLim
    ...
    cDiscDotTaylorLim = applySlopeLimiterTaylor(problemData.g, cDiscDotTaylor, problemData.g.markV0TbdrD, NaN(K,3), problemData.typeSlopeLim);
  ...
  if problemData.isSlopeLim
    ...
    cDiscRK{rkStep + 1} = reshape(applySlopeLimiterDisc(problemData.g, reshape(cDiscRK{rkStep + 1}, [N K])', problemData.g.markV0TbdrD, ...
                            cDV0T, problemData.globM, problemData.globMDiscTaylor, problemData.typeSlopeLim)', [K*N 1]);
  end % if
end % for
