...
if problemData.isQuadri
  fDisc  = projectFuncCont2DataDiscQuadri(problemData.g, @(x1,x2) problemData.fCont(problemData.t(nSubStep),x1,x2),  ...
                                          problemData.qOrd, problemData.globM, problemData.basesOnQuad);
  u1Disc = projectFuncCont2DataDiscQuadri(problemData.g, @(x1,x2) problemData.u1Cont(problemData.t(nSubStep),x1,x2), ...
                                          problemData.qOrd, problemData.globM, problemData.basesOnQuad);
  u2Disc = projectFuncCont2DataDiscQuadri(problemData.g, @(x1,x2) problemData.u2Cont(problemData.t(nSubStep),x1,x2), ...
                                          problemData.qOrd, problemData.globM, problemData.basesOnQuad);
else
...
problemData.globG = assembleMatElemDphiPhiFuncDisc(problemData.g, problemData.hatG, {u1Disc, u2Disc});
...
problemData.globKD = assembleVecEdgePhiIntFuncContVal(problemData.g, problemData.g.markE0TbdrD, ...
                        ...
                        problemData.basesOnQuad, [], problemData.qOrd); %, problemData.g.areaE0TbdrD);
