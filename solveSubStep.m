...
%   qSys{m}(markSetToZero) = 0;
end % for m

% Vertical velocity
cSys{3} = problemData.globHQup \ (problemData.globJu{1} + problemData.globJu{2} + problemData.tildeGlobJu + problemData.tildeGlobJh + ...
                                   0.5 * (problemData.tildeGlobJuRiem + problemData.tildeGlobJhRiem + problemData.globJuhRiem) + ...
                                   problemData.globJuCoupling{1} + problemData.globJwCoupling + problemData.globKh + ...
                                  (problemData.globHQavg + problemData.tildeGlobP + problemData.tildeGlobPbdr) * cSys{2});
...
cSys{1} = problemData.omega(nSubStep) * reshape(problemData.cDiscRK{1, 1}.', [], 1) + ...
          (1 - problemData.omega(nSubStep)) * ( cSys{1} + problemData.tau * ( ...
            problemData.globLh + problemData.barGlobM \ ( -problemData.barGlobJuh - 0.5 * problemData.barGlobJuhRiem - ...
              problemData.barGlobJu - 0.5 * problemData.barGlobJuRiem - problemData.barGlobJh - 0.5 * problemData.barGlobJhRiem - ...
              problemData.barGlobKh + (problemData.barGlobG - problemData.barGlobP - problemData.barGlobPbdr) * cSys{1}) ) );
