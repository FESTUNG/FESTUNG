% Convert the Taylor into a DG/modal basis representation.
%
%===============================================================================
%> @file projectDataTaylor2DataDisc.m
%>
%> @brief Convert the Taylor into a DG/modal basis representation.
%===============================================================================
%>
%> @brief Convert the Taylor into a DG/modal basis representation.
%>
%> It performs an L2-projection from the Taylor into a DG/modal basis
...
%> @f]
%>
%> @param  dataTaylor      Coefficient matrix @f$\mathbf{C}^\mathrm{Taylor}@f$ of the
...
%>         @f$\mathbf{C}^\mathrm{DG}@f$. @f$[K \times N]@f$
%>
