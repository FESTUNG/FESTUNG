...
%>                    <code>projectFuncCont2DataDiscQuadri()</code>
%>                    @f$[{K} \times {N}]@f$
...
%> @endparblock
%
function ret = assembleVecEdgeQuadriVertPhiIntFuncDiscIntHeightNu(g2D, g1D, markE0T, dataDisc, heightV0T1D, N, qOrd, basesOnQuad)
K = g2D.numT;
[~, W] = quadRule1D(qOrd);
ret = zeros(K, N);
for n = 3 : 4
