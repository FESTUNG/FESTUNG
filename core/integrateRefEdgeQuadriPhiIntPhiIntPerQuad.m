...
%> @retval ret  The computed array @f$[N\times N\times 4\times R]@f$
%>
...
%> @endparblock
%
function ret = integrateRefEdgeQuadriPhiIntPhiIntPerQuad(N, basesOnQuad, qOrd)
validateattributes(basesOnQuad, {'struct'}, {}, mfilename, 'basesOnQuad')
[~, W] = quadRule1D(qOrd);
ret = zeros(N, N, 4, length(W)); % [N x N x 4 x R]
for n = 1 : 4 % 4 edges
  for i = 1 : N
    for j = 1 : N
