...
%> @endparblock
%
function [dataTaylorLim, minMaxV0T] = applySlopeLimiterTaylorStrict(g, dataTaylor, markV0TbdrD, dataV0T, basesOnQuad)
...
for ord = p : -1 : 1
  ...
  for i = 1 : ord
    ...
    if ord > 1
      [alphaTmp, minMaxV0T] = computeVertexBasedLimiter(g, dataTaylorLim(:, ind(1)), valV0T, markV0TbdrD, valV0T);
    else
      [alphaTmp, minMaxV0T] = computeVertexBasedLimiter(g, dataTaylorLim(:, ind(1)), valV0T, markV0TbdrD, dataV0T);
    end
