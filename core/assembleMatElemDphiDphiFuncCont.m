...
for r = 1 : R
  ...
  ret{1} = ret{1} + kron(g.B(:,2,2) .* g.B(:,2,2) .* valOnQuad, refElemDphiDphiPerQuad{1,1}(:, :, r)) ...
                  - kron(g.B(:,2,2) .* g.B(:,2,1) .* valOnQuad, refElemDphiDphiPerQuad{1,2}(:, :, r) + refElemDphiDphiPerQuad{2,1}(:, :, r)) ...
  ...
  ret{2} = ret{2} + kron(g.B(:,1,2) .* g.B(:,1,2) .* valOnQuad, refElemDphiDphiPerQuad{1,1}(:, :, r)) ...
                  - kron(g.B(:,1,2) .* g.B(:,1,1) .* valOnQuad, refElemDphiDphiPerQuad{1,2}(:, :, r) + refElemDphiDphiPerQuad{2,1}(:, :, r)) ...
