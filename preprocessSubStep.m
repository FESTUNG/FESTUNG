...
%===============================================================================
%> @file advection_implicit/preprocessSubStep.m
%>
...
fDisc  = projectFuncCont2DataDisc(problemData.g, @(x1,x2) problemData.fCont(t,x1,x2),  ...
                                  problemData.qOrd, problemData.hatM, problemData.basesOnQuad);
...
vNormalOnQuadEdge = computeFuncContNuOnQuadEdge(problemData.g, @(x1,x2) problemData.u1Cont(t,x1,x2), ...
                      @(x1,x2) problemData.u2Cont(t,x1,x2), problemData.qOrd);
...
problemData.globKD = assembleVecEdgePhiIntFuncContVal(problemData.g, problemData.g.markE0TbdrD, ...
                        @(x1,x2) problemData.cDCont(t,x1,x2), vNormalOnQuadEdge, N, ...
                        problemData.basesOnQuad, problemData.g.areaE0TbdrD, problemData.qOrd);
...
problemData.globKN = assembleVecEdgePhiIntFuncCont(problemData.g, problemData.g.markE0TbdrN, ...
                                                   gNUpwind, N, problemData.basesOnQuad, problemData.qOrd);
