...
problemData.cDiscRK{end, 3} = reshape( problemData.globHQup \ ( ...
                                   problemData.globJu{1} + problemData.globJu{2} + problemData.tildeGlobJu + problemData.tildeGlobJh + ...
                                  ...
                                  (problemData.globHQavg + problemData.tildeGlobP + problemData.tildeGlobPbdr) * reshape(problemData.cDiscRK{end, 2}.', [], 1) ), ...
