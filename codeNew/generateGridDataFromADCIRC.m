...
% properties of a triangulation defined from ADCIRC input files.
%
%===============================================================================
...
%>        of a triangulation @f$\mathcal{T}_h@f$  defined from ADCIRC input files 
%>	  and stores them in the output 
...
g.numE = size(g.V0E, 1);
assert(g.numE == NEDGES, 'Failed to generate grid data.');
