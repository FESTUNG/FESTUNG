% Assembles a matrix, containing integrals of products of one basis function
% with a discontinuous coefficient function.
%
%===============================================================================
%> @file assembleMatElemPhiFuncDiscPerQuad.m
%>
%> @brief Assembles a matrix, containing integrals of products of one basis 
%>        function with a discontinuous coefficient function.
%===============================================================================
%>
...
%> @endparblock
%
function ret = assembleMatElemPhiFuncDiscPerQuad(g, refElemPhiPhiPerQuad, dataDisc)
