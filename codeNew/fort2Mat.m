...
[ ICS, NOLIBF, NWP, NCOR, NTIP, NRAMP, G, NDTVAR, DT, STATIM, RNDAY, IRK, ISLOPE, ITRANS, CONVCR, DRAMP, H0, SLAM0, SFEA0, TAU, CF, CORI, ...
	NTIF, TPK, AMIGT, ETRF, FFT, FACET, NBFR, AMIG, FF, FACE, NSTAE, XEL, YEL, NSTAV, XEV, YEV, NOUTGE, TOUTSGE, TOUTFGE, NSPOOLGE, ...
	NOUTGV, TOUTSGV, TOUTFGV, NSPOOLGV, NHSTAR, NHSINC ] = fort15Read(['fort_' name '.15']);
