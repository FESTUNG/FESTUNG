...
%===============================================================================
%> @file cahn-hilliard/initializeProblem.m
%>
...
%> @brief Fills the problem's data structures with initial data (if applicable).
%>
%> This routine is called after cahn-hilliard/preprocessProblem.m.
%>
...
if problemData.initialLimiting
  cDV0T = computeFuncContV0T(problemData.g, @(x1, x2) problemData.c0Cont(x1, x2));
  cDisc = applySlopeLimiterDisc(problemData.g, cDisc, ...
...
problemData.sysY(1:problemData.K*problemData.N) = reshape(cDisc', problemData.K * problemData.N, 1);
...
problemData.solutionMean = sqrt(2) * sum(problemData.sysY(1:problemData.N:problemData.K*problemData.N) .* problemData.g.areaT);
end % function