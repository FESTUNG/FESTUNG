...
dDisc = projectFuncCont2DataDisc(problemData.g, @(x1,x2) problemData.dCont(t,x1,x2), 2 * problemData.p, problemData.hatM);
fDisc = projectFuncCont2DataDisc(problemData.g, @(x1,x2) problemData.fCont(t,x1,x2), 2 * problemData.p, problemData.hatM);
