...
problemData.globRRD = assembleMatEdgePhiPhiFuncDiscNu(problemData.g, problemData.g.markE0TintBdrD, ...
                      problemData.hatRdiag, problemData.hatRoffdiag, dDisc, problemData.g.areaNuE0TintBdrD);
%% Assembly of Dirichlet boundary contributions.
cDCont = @(x1,x2) problemData.cDCont(t,x1,x2);
% globRD is assembled together with globR
...
problemData.globKD = problemData.eta * assembleVecEdgePhiIntFuncCont(problemData.g, problemData.g.markE0TbdrD, ...
                      cDCont, problemData.N, problemData.basesOnQuad, 2 * problemData.p + 1, ones(problemData.K, 3));
