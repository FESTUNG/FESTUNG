...
%> 
%> This routine calls @link swe_2dv/solveStep.m @endlink
%>
...
problemData.sweData = problemData.sweSteps.solveStep(problemData.sweData, (nStep - 1) * problemData.numSubSteps + nSubStep);
end % function
