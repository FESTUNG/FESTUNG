...
if problemData.isIP
  sysA = sysA + problemData.globAIP - problemData.globBIP - problemData.globBIPD ...
          + 0.5 * problemData.symparam * problemData.globBsym + problemData.penparam * problemData.globBjmp;
  sysU = sysU + problemData.dt * (problemData.sysF - problemData.globM \ ( ...
          sysA * sysU + problemData.globJadv - 0.5 * problemData.symparam * problemData.globJsym + ...
