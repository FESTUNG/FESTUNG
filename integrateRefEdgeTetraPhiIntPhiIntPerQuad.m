...
% in all quadrature points of all edges of the reference square.

%===============================================================================
%> @file integrateRefEdgeTetraPhiIntPhiIntPerQuad.m
%>
...
%>    \in \mathbb{R}^{N\times N\times R\times 4}@f$, which is defined by
%> @f[
%> \left[\hat{\mathsf{R}}^\mathrm{diag}\right]_{i,j,r,n} \;:=\;
...
%> @endparblock
%
function ret = integrateRefEdgeTetraPhiIntPhiIntPerQuad(N, qOrd, basesOnQuad)
